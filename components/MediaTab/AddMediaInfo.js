    ...
    return (
      <Container>
        ...
        <MultiSelect
          ...
          displayKey="name"
          ref={component => {
            this.state.multiSelect = component;
          }}
  ...
  uploadVideo = () => {
    ...
    RNFetchBlob.fetch(
      ...
      [
        ...
        {
          name: "categories",
          data: JSON.stringify(this.state.selectedItems)
        }
      ]
    )
      .then(res => {
      ...
      .catch(err => {
        Toast.show({
          text: "Couldn't reach our service. Please try again later.",
          buttonText: "Okay",
          type: "danger",
          position: "top",
          duration: 5000
